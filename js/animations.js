...
document.addEventListener('DOMContentLoaded', () => {
    ...
    tl.to('.layer-inner', {
        x: 450, // Geser lebih ke kanan untuk munculkan area samping kosong
        duration: 1.5,
        ease: 'power3.inOut'
    ...
    tl.to('.layer-inner', {
        x: -450, // Geser ke kiri untuk munculkan area samping kosong (mirror dari Frame-06)
        duration: 1.5,
        ease: 'power3.inOut'
    ...
    tl.to('.layer-inner', {
        y: 600, // Geser ke atas untuk fokus area atap
        duration: 1.5,
        ease: 'power3.inOut'
    ...
    tl.to('.layer-inner', {
        x: 550, // Geser ke kanan (mirror dari Frame-12 yang -550)
        duration: 1.5,
        ease: 'power3.inOut'
